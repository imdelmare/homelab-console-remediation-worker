...
class OpenCodeEngine:
    ...
    def __init__(self, project_dir: Path, timeout_seconds: int, profile_config: Path | None = None) -> None:
        ...
        self._prompt = "Execute only the assigned remediation task through the fenced MCP bridge."
