...
The default engine is OpenCode 1.18.8. Select an engine via the `ENGINE` env var (currently `opencode` or `codex`). The fenced bridge and lease contract remain identical regardless of the underlying model runtime.
